...
except ImportError:  # older sglang builds lack ParallelismContext; p2p mode unavailable
    ...
    def init(
        ...
        if self.args.colocate:
            ...
            if self.args.update_weight_transfer_mode == "broadcast":
                ...
                assert UpdateWeightP2P is not None, (
                    "p2p weight transfer requires a sglang build with "
                    "sglang.srt.distributed.parallel_state.ParallelismContext"
                )
