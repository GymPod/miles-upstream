...
def resolve_ci_enable_metrics_capture(flag_value, env=None):
    """Resolve the effective --ci-enable-metrics-capture value.
...
def parse_args(add_custom_arguments=None):
    ...
    args.ci_enable_metrics_capture = resolve_ci_enable_metrics_capture(args.ci_enable_metrics_capture)
